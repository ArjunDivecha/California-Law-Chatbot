...
| task_content_sha256 | `7c2334441c3376ee8427ea96beacace08cf86a127b7091015032fe0cc0939eb8` |
| proposition_hashes | 5 — `04a513c99ecc`, `7113a3a117fe`, `9e07bf80872e`, `af3bdc3c479e`, `c5c4eed0c00d` |
| source_hashes | 2 — `0c20a18fb5d2`, `fd46413d3c5c` |

## 2. Prompt (what the model is asked)

```text
The court in our custody trial found that the other parent perpetrated domestic violence two years ago. Opposing counsel says that because of Family Code section 3044 our client is the one who must now prove, by clear and convincing evidence, that joint custody would be harmful, and that the court can simply adopt the child custody evaluator's recommendation to get past the presumption. Draft my response from the supplied authority.
```

## 3. Material criteria and their propositions

### C1. `abstention-008-c1`

**Criterion:** Corrects the burden premise: the presumption operates against the perpetrator and may only be rebutted by a preponderance of the evidence, not by clear and convincing evidence imposed on the other parent.

#### Proposition `abstention-008-p2`
...
#### Proposition `abstention-008-p3`

> To overcome the presumption, the perpetrator of domestic violence must demonstrate that giving that person sole or joint physical or legal custody is in the best interest of the child.
...
### C2. `abstention-008-c2`

**Criterion:** States that the presumption arises on a finding that a party seeking custody perpetrated domestic violence within the previous five years and runs against awarding that person sole or joint physical or legal custody.

#### Proposition `abstention-008-p1`

> The section 3044(a) presumption arises upon a finding that a party seeking custody has perpetrated domestic violence within the previous five years and applies against an award of sole or joint physical or legal custody to that person.
...
### C3. `abstention-008-c3`

**Criterion:** Corrects the evaluator premise: under subdivision (e) the court may not base a domestic-violence finding solely on a child custody evaluator’s conclusions or the Family Court Services recommendation, but shall consider any relevant, admissible evidence submitted by the parties.

#### Proposition `abstention-008-p4`

> Under section 3044(e), the court may not base a finding of perpetrated domestic violence solely on a child custody evaluator’s conclusions or on the Family Court Services recommendation, but shall consider any relevant, admissible evidence submitted by the parties.
...
### C4. `abstention-008-c4`

**Criterion:** Notes that the preference for frequent and continuing contact may not be used to rebut the presumption, in whole or in part.

#### Proposition `abstention-008-p5`
...
```text
the preference for frequent and continuing contact with both parents, as set forth in subdivision (b) of Section 3020, or with the noncustodial parent, as set forth in paragraph (1) of subdivision (a) of Section 3040, may not be used to rebut the presumption, in whole or in part.
```
...
| --- | --- | --- | --- |
| `abstention-008-a1` | contains | preponderance of the evidence | UNSUPPORTED_PROPOSITION |
| `abstention-008-a2` | statute | 3044 | — |
| `abstention-008-a3` | contains | perpetrator | — |
...
./node_modules/.bin/tsx evals/kimi-k3/datasetTools/makeAttestation.ts \
  --task abstention-008 --reviewer REV-A --decision APPROVE \
