...
| field | value |
| --- | --- |
| task_id | `research-009` |
| category | research |
| workflow | research |
| track | frozen_evidence |
| data_class | public |
| dataset_hash | `805e588a4c6979f364ef4cd9d854edee211bf83da0ab506ef0d39e60c1bbfce5` |
| task_content_sha256 | `023b29926e7b6040f9892b9756bed410918877e0f5426d04730739b9377ff87f` |
| proposition_hashes | 6 — `0cbbef3c28ba`, `129917eff33f`, `21efcd68c251`, `343aef6f27f9`, `65a372e76441`, `a73f4416ac66` |
| source_hashes | 2 — `0c20a18fb5d2`, `fd46413d3c5c` |

## 2. Prompt (what the model is asked)

```text
The court made a finding two years ago that my client’s ex perpetrated domestic violence against her, and the ex is now seeking joint legal and physical custody, arguing that the child needs frequent and continuing contact with both parents. Explain the Family Code section 3044 presumption, the standard and the findings needed to overcome it, and tell me which version of section 3044 governs a hearing set for this year.
```
...
**Criterion:** States that a finding of domestic violence within the previous five years creates a rebuttable presumption that sole or joint physical or legal custody to the perpetrator is detrimental to the child’s best interest.

#### Proposition `research-009-p1`

> Upon a finding that a party seeking custody has perpetrated domestic violence within the previous five years against the other party seeking custody, against the child or the child’s siblings, or against a person described in Family Code section 3011(a)(2)(A) with whom the party has a relationship, there is a rebuttable presumption that an award of sole or joint physical or legal custody to that person is detrimental to the best interest of the child.
...
#### Proposition `research-009-p2`

> The section 3044 presumption is triggered by a finding of domestic violence perpetrated within the previous five years.

**Verbatim authoritative excerpt relied on:**

```text
has perpetrated domestic violence within the previous five years against the other party seeking custody of the child
```
...
**Criterion:** States that overcoming the presumption requires both the section 3044(b)(1) best-interest finding and a finding that the subdivision (b)(2) factors on balance support the section 3020 legislative findings.

#### Proposition `research-009-p4`

> To overcome the presumption the court shall find that paragraph (1) of Family Code section 3044(b) is satisfied and shall find that the factors in paragraph (2), on balance, support the legislative findings in Section 3020.
...
**Criterion:** States that the frequent-and-continuing-contact preference may not be used to rebut the presumption, rejecting the ex’s argument.

#### Proposition `research-009-p5`

> The preference for frequent and continuing contact with both parents set forth in Family Code section 3020(b), or with the noncustodial parent under section 3040(a)(1), may not be used to rebut the section 3044 presumption, in whole or in part.
...
**Criterion:** Identifies the governing version of section 3044 as the one effective January 1, 2026.

#### Proposition `research-009-p6`

> The currently enacted Family Code section 3044 shall become effective on January 1, 2026.
...
| --- | --- | --- | --- |
| `research-009-a1` | statute | 3044 | — |
| `research-009-a2` | contains | January 1, 2026 | WRONG_EFFECTIVE_DATE |
| `research-009-a3` | contains | preponderance | — |
...
./node_modules/.bin/tsx evals/kimi-k3/datasetTools/makeAttestation.ts \
  --task research-009 --reviewer REV-A --decision APPROVE \
