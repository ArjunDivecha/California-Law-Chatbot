...
| field | value |
| --- | --- |
| task_id | `research-015` |
| category | research |
| workflow | research |
| track | frozen_evidence |
| data_class | public |
| dataset_hash | `805e588a4c6979f364ef4cd9d854edee211bf83da0ab506ef0d39e60c1bbfce5` |
| task_content_sha256 | `4e0824689d37a14859a6fe40f7e3d6c1162c4faf5131c595fe415b872464a337` |
| proposition_hashes | 5 — `333893f7f4bb`, `371db39c1e40`, `46f46ac37c1d`, `bbac5feef229`, `edb23637d21a` |
| source_hashes | 3 — `889a27cf4bad`, `bc17e7487982`, `ca0c85bcc670` |

## 2. Prompt (what the model is asked)

```text
Post-separation, the managing spouse in a dissolution has been running the community-property business and just quietly took an equity stake in a new venture that grew out of a client relationship he built during the marriage. He has not updated his disclosures in nine months. What fiduciary duties does the Family Code impose after separation and what specifically must he disclose?
```
...
**Criterion:** States that Family Code section 2102 continues the section 721 fiduciary standards from the date of separation until distribution of the asset or liability in question.

#### Proposition `research-015-p1`

> From the date of separation to the date of distribution of the community or quasi-community asset or liability in question, each party is subject to the standards provided in Family Code section 721 as to all activities that affect the assets and liabilities of the other party.
...
**Criterion:** States the ongoing duty of accurate and complete disclosure of assets, liabilities, earnings, accumulations, and expenses, including immediate update or augmentation on material changes.

#### Proposition `research-015-p2`
...
```text
The accurate and complete disclosure of all assets and liabilities in which the party has or may have an interest or obligation and all current earnings, accumulations, and expenses, including an immediate, full, and accurate update or augmentation to the extent there have been material changes.
```
...
**Criterion:** States that the new equity stake must be disclosed in writing under section 2102(a)(2) because it presented itself after separation but results from business activity or an income-producing opportunity arising between marriage and separation.

#### Proposition `research-015-p3`

> Those duties include the accurate and complete written disclosure of any investment, business, or other income-producing opportunity that presents itself after the date of separation but results from any investment, significant business activity outside the ordinary course of business, or other income-producing opportunity of either spouse from the date of marriage to the date of separation.
...
**Criterion:** States that the section 721 confidential relationship imposes a duty of the highest good faith and fair dealing and forbids taking unfair advantage of the other spouse.

#### Proposition `research-015-p4`
...
**Criterion:** States the Family Code section 1100(e) obligation of full disclosure of material facts regarding the existence, characterization, and valuation of community assets.

#### Proposition `research-015-p5`

> The management-and-control fiduciary duty includes the obligation to make full disclosure to the other spouse of all material facts and information regarding the existence, characterization, and valuation of all assets in which the community has or may have an interest and debts for which the community is or may be liable, and to provide equal access to all information, records, and books pertaining to their value and character.

**Verbatim authoritative excerpt relied on:**

```text
This duty includes the obligation to make full disclosure to the other spouse of all material facts and information regarding the existence, characterization, and valuation of all assets in which the community has or may have an interest
```
...
| --- | --- | --- | --- |
| `research-015-a1` | statute | 2102 | — |
| `research-015-a2` | statute | 721 | — |
| `research-015-a3` | contains | fiduciary | — |
...
./node_modules/.bin/tsx evals/kimi-k3/datasetTools/makeAttestation.ts \
  --task research-015 --reviewer REV-A --decision APPROVE \
