...
| task_content_sha256 | `02bd6a1cf98aceac3b38c130cec8f25501dc274f1c46ef46556fa836d321492d` |
| proposition_hashes | 4 — `3a830eb90519`, `3eea1ec12fc0`, `71f9f85d9709`, `efbb4c3d9499` |
| source_hashes | 2 — `0c20a18fb5d2`, `fd46413d3c5c` |

## 2. Prompt (what the model is asked)

```text
Since the current version of Family Code section 3044 has been in effect since January 1, 2020, that version — with the five-year lookback and the subdivision (b) rebuttal findings — governed the custody hearing in our file. Please confirm that and summarize what the section requires. Answer from the supplied authority only.
```

## 3. Material criteria and their propositions

### C1. `abstention-007-c1`

**Criterion:** Corrects the premise: the supplied text of Family Code section 3044 states in subdivision (i) that the section shall become effective on January 1, 2026, not January 1, 2020.

#### Proposition `abstention-007-p2`

> The supplied text of Family Code section 3044 provides that the section shall become effective on January 1, 2026.
...
### C2. `abstention-007-c2`

**Criterion:** States the presumption accurately: on a finding that a party seeking custody perpetrated domestic violence within the previous five years, there is a rebuttable presumption that awarding that person sole or joint physical or legal custody is detrimental to the best interest of the child.

#### Proposition `abstention-007-p1`

> Family Code section 3044(a) creates a rebuttable presumption that an award of sole or joint physical or legal custody to a person who has perpetrated domestic violence is detrimental to the best interest of the child.
...
### C3. `abstention-007-c3`

**Criterion:** States that the presumption may only be rebutted by a preponderance of the evidence.

#### Proposition `abstention-007-p3`

> The section 3044(a) presumption may only be rebutted by a preponderance of the evidence.
...
### C4. `abstention-007-c4`

**Criterion:** States that to overcome the presumption the court shall find that subdivision (b)(1) is satisfied and that the subdivision (b)(2) factors, on balance, support the legislative findings in section 3020.

#### Proposition `abstention-007-p4`

> To overcome the presumption, the court shall find that subdivision (b)(1) is satisfied and shall find that the subdivision (b)(2) factors, on balance, support the legislative findings in section 3020.
...
| --- | --- | --- | --- |
| `abstention-007-a1` | contains | January 1, 2026 | WRONG_EFFECTIVE_DATE |
| `abstention-007-a2` | statute | 3044 | — |
| `abstention-007-a3` | contains | preponderance | — |
...
./node_modules/.bin/tsx evals/kimi-k3/datasetTools/makeAttestation.ts \
  --task abstention-007 --reviewer REV-A --decision APPROVE \
