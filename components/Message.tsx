...
const Message: React.FC<MessageProps> = ({ message }) => {
    ...
    return (
      <div className="flex justify-end">
        <div className="flex items-start gap-3 w-full max-w-[85%]">
          <div className="max-w-[32rem] rounded-2xl rounded-br-md border border-slate-200 bg-gradient-to-br from-slate-50 to-white px-4 py-2.5 shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
  ...
  const responseMode = message.responseMode || 'accuracy';
  
  // Get mode badge
  const getModeBadge = () => {
    if (responseMode === 'speed') {
      return (
        <div className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-rose-100 text-rose-800">
